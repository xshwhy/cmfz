	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
				...
				$("#t1").prop("src","${pageContext.request.contextPath}/user/captchaCode?time="+date.getSeconds());
			})
			...
			<form id="loginForm" action="${pageContext.request.contextPath}/user/login" method="post" >
				...
				<table>
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img  id="t1" src="${pageContext.request.contextPath}/user/captchaCode"/>
							<td><a href="javascript:void(0)" id="captchaImage" >看不清，换一张</a></td>
							</td>
						</tr>					
					<tr>
						<td>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton" value="登录" onclick="login()">
